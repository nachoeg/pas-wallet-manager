	...
	public SecurityFilterChain filterChain(HttpSecurity http, JwtService jwtService,
		...
		http.csrf().disable()
				.authorizeHttpRequests(auth -> auth
						...
						.requestMatchers(POST, "/wallet-manager/api/create")
						.hasAnyAuthority(ROLE_PREFIX + ADMIN.name(), ROLE_PREFIX + PUBLIC.name(), ROLE_PREFIX + BUYER.name())
						.requestMatchers(GET, "/wallet-manager/api/{user_id}/balance")
						.hasAnyAuthority(ROLE_PREFIX + ADMIN.name(), ROLE_PREFIX + OWNER.name())
						.requestMatchers(POST, "/wallet-manager/api/{user_id}/deposit")
						.hasAnyAuthority(ROLE_PREFIX + ADMIN.name(), ROLE_PREFIX + OWNER.name())
						.requestMatchers(POST, "/wallet-manager/api/{user_id}/withdraw")
						.hasAnyAuthority(ROLE_PREFIX + ADMIN.name(), ROLE_PREFIX + OWNER.name())
						.requestMatchers(GET, "/wallet-manager/api/{user_id}/history")
						.hasAnyAuthority(ROLE_PREFIX + ADMIN.name(), ROLE_PREFIX + OWNER.name())
